 ...
 *
 * Every src/api/*.ts module and every route handler imports from this
 ...
 * contract with src/ui/lib/api.ts (frontend) and must stay drop-in compatible
...
import { z } from "zod";
import { isValidCron } from "@/api/automations";
import { hostAllowedByList, isValidEgressHost } from "@/shared/egress-hosts";
import { decrypt, encrypt } from "@/api/integrations/core/crypto";
import type { SessionOrigin } from "@/api/integrations/core/origin";
...
// ============================================================================
// Automations (scheduled session triggers — see src/api/automations.ts)
// ============================================================================
...
// Memory bodies — see src/api/memory.ts for the model.
...
// ============================================================================
// API response shapes — keep field names identical to frontend src/ui/lib/api.ts
...
export interface ServerEnv {
  ...
  // env-load time when unset; see src/api/auth/agent-token.ts.
