---
title: "Introduction"
description: "1 place to call all your agents - OpenCode, Hermes, Claude Managed Agents, Cursor Agents API, DeepAgents."
---
...
<CardGroup cols={2}>
  ...
  <Card title="Runtimes" icon="server" href="/runtimes/claude-managed-agents">
    Claude Managed Agents, Cursor, OpenCode, DeepAgents, Elastic.
  </Card>
